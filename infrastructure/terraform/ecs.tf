  ...
  container_definitions = jsonencode([
    {
      ...
      secrets = [
        # These will need to be created in AWS Secrets Manager
        # Example: aws secretsmanager create-secret --name /innonet/production/database-url --secret-string "postgresql://..."
      ]
...
# TODO: Add HTTPS listener when ACM certificate is created
